...
public class DfaSensitiveWordService {
    private static final Logger log = LoggerFactory.getLogger(DfaSensitiveWordService.class);
    ...
    public DfaSensitiveWordService() {
    ...
    public synchronized void initWordTree(Collection<String> words) {
        ...
        log.info("Initialized DfaSensitiveWordService with {} sensitive keywords.", words.size());
    }
