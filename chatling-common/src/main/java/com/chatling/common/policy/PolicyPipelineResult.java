...
public class PolicyPipelineResult implements Serializable {
    ...
    private PolicyPipelineResult(Status status, int rejectCode, String message, String fallbackModel, String hitRuleCode, String modifiedPrompt, boolean isModified) {
        this.status = status;
    ...
    public static PolicyPipelineResult pass() {
        return new PolicyPipelineResult(Status.PASS, 200, "PASS", null, null, null, false);
    }

    public static PolicyPipelineResult pass(String modifiedPrompt) {
        return new PolicyPipelineResult(Status.PASS, 200, "PASS", null, null, modifiedPrompt, modifiedPrompt != null);
    }

    public static PolicyPipelineResult reject(int rejectCode, String message, String hitRuleCode) {
        return new PolicyPipelineResult(Status.REJECTED, rejectCode, message, null, hitRuleCode, null, false);
    }

    public static PolicyPipelineResult fallback(String fallbackModel, String hitRuleCode) {
        return new PolicyPipelineResult(Status.FALLBACK, 200, "FALLBACK", fallbackModel, hitRuleCode, null, false);
    }

    public static PolicyPipelineResult mask(String modifiedPrompt, String hitRuleCode, String message) {
        return new PolicyPipelineResult(Status.MASKED, 200, message != null ? message : "MASKED", null, hitRuleCode, modifiedPrompt, true);
    }
